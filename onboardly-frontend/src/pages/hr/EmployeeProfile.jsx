...
// TODO: Replace mock data with real backend calls when employee profile APIs are ready.
...
const mockDocuments = [
  ...
  },
  {
    ...
    url: "/company-policy.pdf",
    createdDate: "2026-05-18",
  },
  {
    id: 3,
    name: "Direct Deposit Form",
    url: "/direct-deposit.pdf",
...
function toPersonalRequest(draft, fallback = {}) {
  return {
    email:
      ...
      fallback.email ||
      "",
    personalEmail: draft.personalEmail || fallback.personalEmail || null,
    cellPhone: draft.cellPhone || null,
    alternatePhone: draft.alternatePhone || null,
    workPhone: draft.workPhone || fallback.workPhone || null,
...
export default function EmployeeProfile() {
  ...
  const onboardingStatus = profile?.applications?.[0]?.status;
  const isPendingOnboarding = onboardingStatus === "PENDING" || onboardingStatus === "NOT_STARTED";
    ...
    <div className="pi-page">
      {isPendingOnboarding && (
        <Alert
          ...
          message={`Onboarding application is ${onboardingStatus === "PENDING" ? "pending review" : "not yet submitted"}`}
          action={
            <Button size="small" type="primary" onClick={() => navigate(`/hr/form-application/${id}`)}>
      ...
      <div className="pi-title-row">
        <div className="pi-profile-summary">
          ...
          <div className="pi-profile-summary-main">
            ...
            <Text type="secondary">
              {profile.workEmail || profile.email || profile.personalEmail || "No email on file"}
            </Text>
          </div>
